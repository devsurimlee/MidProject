...
if('${answerMessage}' != ''){
	...
	function deleteQna(){
        ...
        if(result == true) {
        	location.href = 'basic_qnaDelete.do?id='+qbId;
        } else {
        	false;
        }
	}
	...
	function answerQna(){
		var qbId = ${content.qbId };
		location.href = 'basic_qnaAnswerForm.do?id='+qbId;
	}
</script>
</head>
<body>
					...
					<table>
						<tr>
							...
							<td width="200" align="right">
								<button type="button" onclick="location.href='basic_qnaListForm.do?title=${content.qbTitle}'" class="btn btn-outline-primary"> LIST </button>
								</td>
						</tr>
					</table>
				</div>
