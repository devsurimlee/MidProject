		...
		<div class="row">
			...
			<div class="col-md-8">
				<div>
					...
					<form role="form" id="insertfrm" name="insertfrm" action="basic_qnaAnswer.do">
						...
						<table>
							<tr>
								...
								<td width="200" align="right">
									<button type="button" onclick="location.href='basic_qnaListForm.do?title=상품문의'" class="btn btn-outline-primary"> LIST </button>
									</td>
							</tr>
						</table>
					</form>
