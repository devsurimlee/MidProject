...
<body>
	<div align="center">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<div>
					<form role="form" id="updatefrm" name="updatefrm" action="admin_noticeUpdate.do">
						...
						<table>
							<tr>
								<td width="100"><button type="submit" onclick="location.href='admin_noticeUpdate.do'" class="btn btn-outline-primary"> UPDATE </button></td>
								<td width="500"></td>
