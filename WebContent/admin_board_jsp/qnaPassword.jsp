...
<body>
	...
	<div class="row">
		...
		<div class="col-md-6" align="center">
			<form role="form" id="pwfrm" name="pwfrm" action="admin_qnaPassword.do">
				...
				<table>
					...
					<tr>
						<td colspan="2"><button type="button" onclick="location.href='admin_qnaListForm.do?title=상품문의'" class="btn btn-md btn-primary btn-block"> LIST </button></td>
					</tr>
				</table>
			</form>
		</div>
