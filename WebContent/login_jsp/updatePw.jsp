...
<body>
	<div align="center">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<form role="form" id="updatePwfrm" name="updatePwfrm" action="basic_updatePw.do">
					<table>
						<tr>
						...
						<tr>
							<td colspan="2" height="60"><button type="button" onclick="updatePw()" 
														class="btn btn-md btn-primary btn-block"> RESET PASSWORD </button></td>
						</tr>
						<tr>
							<td colspan="2"><button type="button" onclick="location.href='basic_mypageForm.do'"
